      ...
      children: [
        Expanded(
          child: OutlinedButton(
            ...
            child: const Text(
              'Previous',
              style: TextStyle(color: Color(0xFF6F5AAA), fontSize: 16),
            ),
          ),
        ),
        const SizedBox(width: 16),
        Expanded(child: nextOrSubmitButton),
      ],
    );
  }
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(
              height: 24,
            ), // Increased gap between question and options
            Column(
              children: List.generate(q.options.length, (optIndex) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected
                        ? const Color(0xFF6F5AAA).withValues(alpha: 0.05)
                        : Colors.white,
                    borderRadius: BorderRadius.circular(14),
                    border: Border.all(
                      color: isSelected
                          ? const Color(0xFF6F5AAA)
                          : const Color(0xFFE4DDEE),
